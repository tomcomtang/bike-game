...
MyGame.Game.prototype = {
  create: function () {
    ...
    this.proName = this.add.text(game.world.width / 2, 46, 'Riding Formation', { font: "bold 38px Microsoft YaHei", fill: "#5b3716", align: 'center' })
  ...
  update: function () {
    game.physics.arcade.collide(this.player, this.road, this.hitRoad, null, this); // Check collision with ground
